...
export default (props) => (
  <>
    ...
    <img className="img-fluid rounded my-3" src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f0/Gullfoss_from_the_Air.jpg/1024px-Gullfoss_from_the_Air.jpg" alt={props.title} />
